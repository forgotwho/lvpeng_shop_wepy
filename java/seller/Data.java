...
public class Data {
    ...
    private List<MemberPresentRules> memberPresentRules;
    ...
    public void setMemberPresentRules(List<MemberPresentRules> memberPresentRules) {
         this.memberPresentRules = memberPresentRules;
     }
     public List<MemberPresentRules> getMemberPresentRules() {
