...
public class DiscountRules {
    ...
    private List<DiscountCategoryLists> discountCategoryLists;
    ...
    public void setDiscountCategoryLists(List<DiscountCategoryLists> discountCategoryLists) {
         this.discountCategoryLists = discountCategoryLists;
     }
     public List<DiscountCategoryLists> getDiscountCategoryLists() {
